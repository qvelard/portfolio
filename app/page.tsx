...
const skillCategories = [
  {
    ...
    technologies: ['PyTorch', 'TensorFlow', 'JAX', 'Scikit-learn', 'Hugging Face'],
    color: 'bg-blue-500/10 text-blue-700 dark:text-blue-300'
  },
  {
    category: 'Computer Vision & NLP',
    technologies: ['OpenCV', 'Transformers', 'LangChain', 'Diffusion Models', 'RAG'],
    color: 'bg-green-500/10 text-green-700 dark:text-green-300'
  },
  {
    category: 'MLOps & Cloud',
    technologies: ['Docker', 'AWS', 'CI/CD', 'Distributed Training', 'Vercel'],
    color: 'bg-orange-500/10 text-orange-700 dark:text-orange-300'
  },
  {
    category: 'Languages & Tools',
    technologies: ['Python', 'TypeScript', 'R', 'FastAPI', 'Next.js', 'Git'],
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-20 py-10">
      ...
      {/* Contact Section */}
      <section id="contact" className="container mx-auto px-3 sm:px-8 lg:px-16 scroll-mt-20">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
